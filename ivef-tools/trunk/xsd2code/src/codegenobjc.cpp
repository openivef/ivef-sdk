...
//    classFileOut << "         [self parse];\n";
    ...
    classFileOut << "         NSXMLParser *tempParser = [[NSXMLParser alloc] initWithData:[messages dataUsingEncoding:NSASCIIStringEncoding]];\n";
