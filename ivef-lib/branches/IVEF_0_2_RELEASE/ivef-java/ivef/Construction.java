...
public class Construction { 
    ...
    public String toXML() {
        ...
        if ( hasMaxKeelHeight() ) {
            xml += " MaxKeelHeight=\"" + nf.format(m_maxKeelHeight) + "\"";
        }
        if ( hasMaxDraught() ) {
            xml += " MaxDraught=\"" + nf.format(m_maxDraught) + "\"";
        }
        if ( hasMaxPersonsOnBoard() ) {
            xml += " MaxPersonsOnBoard=\"" + nf.format(m_maxPersonsOnBoard) + "\"";
        }
        if ( hasMaxSpeed() ) {
    ...
    public String toString(String lead) {
        ...
        if ( hasMaxKeelHeight() ) {
            str +=  lead + "    MaxKeelHeight = " + nf.format(m_maxKeelHeight) + "\n";
        }
        if ( hasMaxDraught() ) {
            str +=  lead + "    MaxDraught = " + nf.format(m_maxDraught) + "\n";
        }
        if ( hasMaxPersonsOnBoard() ) {
            str +=  lead + "    MaxPersonsOnBoard = " + nf.format(m_maxPersonsOnBoard) + "\n";
        }
        if ( hasMaxSpeed() ) {
