...
public class Body { 
    ...
    private ObjectData m_objectData; // default value is uninitialized
    ...
    public Body(Body val) {
        ...
        m_objectDataPresent = val.hasObjectData();
        m_objectData = val.getObjectData();
    ...
    public void setObjectData(ObjectData val) {
    ...
    public String toString(String lead) {
        ...
        if ( hasObjectData() ) {
            str +=  m_objectData.toString(lead + "    ") ;
        }
        if ( hasPing() ) {
