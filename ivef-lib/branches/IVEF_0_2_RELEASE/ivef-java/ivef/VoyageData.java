...
public class VoyageData { 
    ...
    public String toXML() {
        ...
        if ( hasOverSizedLength() ) {
            xml += " OverSizedLength=\"" + nf.format(m_overSizedLength) + "\"";
        }
        if ( hasOverSizedWidth() ) {
            xml += " OverSizedWidth=\"" + nf.format(m_overSizedWidth) + "\"";
        }
        if ( hasNextPort() ) {
            xml += " NextPort=\"" + encode( m_nextPort) + "\"";
        }
        if ( hasPersonsOnBoard() ) {
            xml += " PersonsOnBoard=\"" + nf.format(m_personsOnBoard) + "\"";
        }
        if ( hasPilots() ) {
    ...
    public String toString(String lead) {
        ...
        if ( hasOverSizedLength() ) {
            str +=  lead + "    OverSizedLength = " + nf.format(m_overSizedLength) + "\n";
        }
        if ( hasOverSizedWidth() ) {
            str +=  lead + "    OverSizedWidth = " + nf.format(m_overSizedWidth) + "\n";
        }
        if ( hasNextPort() ) {
            str +=  lead + "    NextPort = " + m_nextPort + "\n";
        }
        if ( hasPersonsOnBoard() ) {
            str +=  lead + "    PersonsOnBoard = " + nf.format(m_personsOnBoard) + "\n";
        }
        if ( hasPilots() ) {
