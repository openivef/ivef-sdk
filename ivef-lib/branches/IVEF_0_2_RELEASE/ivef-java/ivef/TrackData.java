...
public class TrackData { 
    ...
    public String toXML() {
        ...
        xml += " COG=\"" + m_COG + "\"";
        if ( hasEstAccSOG() ) {
            xml += " EstAccSOG=\"" + m_estAccSOG + "\"";
        }
        if ( hasEstAccCOG() ) {
            xml += " EstAccCOG=\"" + m_estAccCOG + "\"";
        }
        xml += " Id=\"" + m_id + "\"";
        if ( hasLength() ) {
            xml += " Length=\"" + m_length + "\"";
    ...
    public String toString(String lead) {
        ...
        str +=  lead + "    COG = " + m_COG + "\n";
        if ( hasEstAccSOG() ) {
            str +=  lead + "    EstAccSOG = " + m_estAccSOG + "\n";
        }
        if ( hasEstAccCOG() ) {
            str +=  lead + "    EstAccCOG = " + m_estAccCOG + "\n";
        }
        str +=  lead + "    Id = " + m_id + "\n";
        if ( hasLength() ) {
