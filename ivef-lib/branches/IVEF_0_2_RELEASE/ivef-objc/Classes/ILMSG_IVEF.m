...
-(NSString *) XML {
    ...
    NSMutableString *xml = [NSMutableString stringWithString:@"<MSG_IVEF"];
    [xml appendString:@">\n"];
    if ( m_headerPresent ) {
...
-(NSString *) stringValueWithLead: (NSString *) lead {
    ...
    [str setString: [lead stringByAppendingString:@"MSG_IVEF\n"]];
