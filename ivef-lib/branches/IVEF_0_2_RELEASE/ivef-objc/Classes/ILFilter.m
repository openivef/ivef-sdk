...
-(NSString *) XML {
    ...
    if ( m_predicatePresent ) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"ILValidationError" object: self userInfo: [NSDictionary dictionaryWithObject: @"Predicate" forKey: @"description"]];
        return nil;
    }
    [xml appendString:@"/>\n"];
    return xml;
