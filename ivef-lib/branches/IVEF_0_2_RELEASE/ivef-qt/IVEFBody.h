...
public:
    ...
    //!              sets the ObjectData: MESSAGE sent by the supplier containing data regarding objects in its domain
    //!
    void setObjectData(ObjectData val);

    //!              gets the ObjectData: MESSAGE sent by the supplier containing data regarding objects in its domain
    //!
    //! \return     ObjectData
    //!
    ObjectData getObjectData() const;

    //!              returns true if ObjectDatais used (optional field).
    //!
    //! \return     bool
    bool hasObjectData();
