...
public class PosReport { 
    ...
    private Date m_expectedTimeForNextUpdate; // default value is uninitialized
    private boolean m_expectedTimeForNextUpdatePresent;
    ...
    public PosReport(PosReport val) {
        ...
        m_expectedTimeForNextUpdate = val.getExpectedTimeForNextUpdate();
        if (val != null) {
    ...
    public boolean removeSensor(Sensor val) {
          if (m_sensors.size() <= 0) {
              return false; // scalar already at minOccurs
          }

        m_sensors.remove(val);
          return true;
    }
    ...
    public boolean setExpectedTimeForNextUpdate(Date val) {
    ...
    public Date getExpectedTimeForNextUpdate() {

        return m_expectedTimeForNextUpdate;
    }

    public boolean hasExpectedTimeForNextUpdate() {
    ...
    public String toXML() {
        ...
        if ( hasExpectedTimeForNextUpdate() ) {
            xml += " ExpectedTimeForNextUpdate=\"" + df.format(m_expectedTimeForNextUpdate) + "\"";
        }
        if ( m_SOGPresent ) {
    ...
    public String toString(String lead) {
        ...
        if ( hasExpectedTimeForNextUpdate() ) {
            str +=  lead + "    ExpectedTimeForNextUpdate = " + df.format(m_expectedTimeForNextUpdate) + "\n";
        }
