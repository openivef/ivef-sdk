...
public:
    ...
    //!              sets the ETA: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sss) of the Expected Time Of Arrival of the target.
    //!
    void setETA(QDateTime val);

    //!              gets the ETA: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sss) of the Expected Time Of Arrival of the target.
    //!
    //! \return     QDateTime
    //!
    ...
    //!              sets the ATA: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sss) of the Actual Time Of Arrival of the target.
    //!
    void setATA(QDateTime val);

    //!              gets the ATA: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sss) of the Actual Time Of Arrival of the target.
    //!
    //! \return     QDateTime
    //!
