...
public:
    ...
    //!              sets the Id: The unique identification of this object, typically identical to Id in the PosReport, but not required
    //!
    void setId(int val);

    //!              gets the Id: The unique identification of this object, typically identical to Id in the PosReport, but not required
    //!
    //! \return     int
    //!
    int getId() const;
