...
@implementation IVEFMSG_VesselData
...
-(NSString *) XML {
    ...
    NSMutableString *xml = [NSMutableString stringWithString:@"<MSG_VesselData"];
    [xml appendString:@">\n"];
    [xml appendString: [m_header XML] ];
    [xml appendString: [m_body XML] ];
    [xml appendString: @"</MSG_VesselData>\n"];
    return xml;
}
...
-(NSString *) stringValueWithLead: (NSString *) lead {
    ...
    [str setString: [lead stringByAppendingString:@"MSG_VesselData\n"]];
