...
//
//  MSG_LoginRequest is distributed in the hope that it will be useful,
...
class MSG_LoginRequest { 
    ...
    public function MSG_LoginRequest() {
    ...
    public function toXML() {
        ...
        $xml = new SimpleXMLElement("<MSG_LoginRequest></MSG_LoginRequest>");
