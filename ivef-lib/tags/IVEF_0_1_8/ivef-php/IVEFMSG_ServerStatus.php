...
//
//  MSG_ServerStatus is distributed in the hope that it will be useful,
...
class MSG_ServerStatus { 
    ...
    public function MSG_ServerStatus() {
    ...
    public function toXML() {
        ...
        $xml = new SimpleXMLElement("<MSG_ServerStatus></MSG_ServerStatus>");
