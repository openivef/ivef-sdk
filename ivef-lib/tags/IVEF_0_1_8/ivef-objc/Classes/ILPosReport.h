...
@interface ILPosReport : NSObject { 
    ...
    NSDate *m_expectedTimeForNextUpdate;
...
/* ExpectedTimeForNextUpdate:
   Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sssZ) the next update is expected, this can be used to detect low updating tracks. */
//!Setter for ExpectedTimeForNextUpdate
//!
-(BOOL) setExpectedTimeForNextUpdate:(NSDate *) val;
//!Getter for ExpectedTimeForNextUpdate
//!
-(NSDate *) expectedTimeForNextUpdate;
//!Test for pressence of ExpectedTimeForNextUpdate
//!
