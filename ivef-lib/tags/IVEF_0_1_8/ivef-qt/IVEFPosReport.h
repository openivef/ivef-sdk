...
public:
    ...
    //!== operator
    //!
    bool operator==(const PosReport&/*val*/);
    //!              sets the Pos
    //!
    bool setPos(Pos val);
    ...
    //!              sets the ExpectedTimeForNextUpdate: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sssZ) the next update is expected, this can be used to detect low updating tracks.
    //!
    bool setExpectedTimeForNextUpdate(QDateTime val);

    //!              gets the ExpectedTimeForNextUpdate: Date and time in ISO 8601 UTC format (YYYY-MM-DDThh:mm:ss.sssZ) the next update is expected, this can be used to detect low updating tracks.
    //!
    //! \return     QDateTime
    //!
    QDateTime getExpectedTimeForNextUpdate() const;

    //!              returns true if ExpectedTimeForNextUpdateis used (optional field).
    //!
    //! \return     bool
    bool hasExpectedTimeForNextUpdate() const;
...
private:
    ...
    QDateTime m_expectedTimeForNextUpdate;
    bool m_expectedTimeForNextUpdatePresent;
    float m_SOG;
    bool m_SOGPresent;
    float m_COG;
    bool m_COGPresent;
