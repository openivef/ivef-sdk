...
public:
    ...
    //!
    bool setLoginRequest(LoginRequest val);
    ...
    //!
    bool setLoginResponse(LoginResponse val);
    ...
    //!
    bool setServerStatus(ServerStatus val);
    ...
    //!
    bool setServiceRequest(ServiceRequest val);
