 ...
 *  Generated by xsd2code on Wed May 20 17:30:52 2009.
 **********************************************************************************
 *  Copyright 2008
 *
 */
...
public class Parser extends DefaultHandler { 
    ...
    public boolean parseXMLString(String data, boolean cont) { 
     ...
     index[0] = m_dataBuffer.lastIndexOf("</MSG_VesselData>") + ("</MSG_VesselData>").length();
     index[1] = m_dataBuffer.lastIndexOf("</MSG_LoginRequest>") + ("</MSG_LoginRequest>").length();
     index[2] = m_dataBuffer.lastIndexOf("</MSG_LoginResponse>") + ("</MSG_LoginResponse>").length();
     ...
     index[6] = m_dataBuffer.lastIndexOf("</MSG_Logout>") + ("</MSG_Logout>").length();
     index[7] = m_dataBuffer.lastIndexOf("</MSG_ServiceRequest>") + ("</MSG_ServiceRequest>").length();
     for (int i=0; i<8; i++) {
         if (index[i] > indexMax) {
             indexMax = index[i];
         }
