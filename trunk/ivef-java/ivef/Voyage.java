...
public class Voyage { 
    ...
    private float m_airDraught;
    private boolean m_airDraughtPresent;
    private float m_draught;
    ...
    public void setAirDraught(float val) {
    ...
    public void setDraught(float val) {
    ...
    public String toXML() {
        ...
        if ( hasETA() ) {
            xml += " ETA=\"" + DateFormat.getDateInstance().format(m_ETA) + "\"";
        }
        if ( hasATA() ) {
            xml += " ATA=\"" + DateFormat.getDateInstance().format(m_ATA) + "\"";
        }
        if ( hasAirDraught() ) {
    ...
    public String toString(String lead) {
        ...
        if ( hasETA() ) {
            str +=  lead + "    ETA = " + DateFormat.getDateInstance().format(m_ETA) + "\n";
        }
        if ( hasATA() ) {
            str +=  lead + "    ATA = " + DateFormat.getDateInstance().format(m_ATA) + "\n";
        }
        if ( hasAirDraught() ) {
