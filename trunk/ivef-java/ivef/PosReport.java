...
public class PosReport { 
    ...
    private int m_navStatus;
    private boolean m_navStatusPresent;
    private int m_updSensorType;
    private boolean m_updSensorTypePresent;
    private boolean m_ATONOffPos;
    ...
    public void setRateOfTurn(float val) {
    ...
    public String toXML() {
        ...
        xml += " UpdateTime=\"" + DateFormat.getDateInstance().format(m_updateTime) + "\"";
        xml += " SOG=\"" + m_SOG + "\"";
        xml += " COG=\"" + m_COG + "\"";
        xml += " Lost=\"" + m_lost + "\"";
        if ( hasRateOfTurn() ) {
    ...
    public String toString(String lead) {
        ...
        str +=  lead + "    UpdateTime = " + DateFormat.getDateInstance().format(m_updateTime) + "\n";
        str +=  lead + "    SOG = " + m_SOG + "\n";
        str +=  lead + "    COG = " + m_COG + "\n";
