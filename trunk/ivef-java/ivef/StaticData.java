...
public class StaticData { 
    ...
    public void setBreadth(float val) {
    ...
    public void setAntPosDistFromFront(float val) {

        m_antPosDistFromFrontPresent = true;
        m_antPosDistFromFront = val;
    }

    public float getAntPosDistFromFront() {
    ...
    public void setAntPosDistFromLeft(float val) {

        m_antPosDistFromLeftPresent = true;
        m_antPosDistFromLeft = val;
    }

    public float getAntPosDistFromLeft() {
    ...
    public void setMaxAirDraught(float val) {

        m_maxAirDraughtPresent = true;
        m_maxAirDraught = val;
    }

    public float getMaxAirDraught() {
    ...
    public void setMaxDraught(float val) {
    ...
    public String toXML() {
        ...
        if ( hasCallsign() ) {
            xml += " Callsign=\"" + m_callsign + "\"";
        }
        if ( hasShipName() ) {
            xml += " ShipName=\"" + m_shipName + "\"";
        }
        if ( hasObjectType() ) {
        ...
        if ( hasNatLangShipName() ) {
            xml += " NatLangShipName=\"" + m_natLangShipName + "\"";
        }
        if ( hasPortOfRegistry() ) {
            xml += " PortOfRegistry=\"" + m_portOfRegistry + "\"";
        }
        if ( hasCountryFlag() ) {
            xml += " CountryFlag=\"" + m_countryFlag + "\"";
        }
        if ( hasMaxAirDraught() ) {
        ...
        if ( hasDeepWaterVesselind() ) {
            xml += " DeepWaterVesselind=\"" + m_deepWaterVesselind + "\"";
        }
        xml += ">\n";
        xml += "</StaticData>\n";
        return xml;
