...
ServiceRequest::ServiceRequest(const ServiceRequest &val) : QObject() {
    ...
    m_notification = val.m_notification;
}
...
void ServiceRequest::setNotification(Notification val) {

    m_notification = val;
}

Notification ServiceRequest::getNotification() const {
...
QString ServiceRequest::toXML() {
    ...
    xml.append( m_notification.toXML() );
...
QString ServiceRequest::toString(QString lead) {
    ...
    str.append( m_notification.toString(lead + "    ") );
    return str;
}
